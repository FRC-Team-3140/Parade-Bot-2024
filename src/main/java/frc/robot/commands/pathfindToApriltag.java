...
public class pathfindToApriltag extends Command {
  ...
  private DifferentialDriveSubsystem swerveDrive;
  private boolean pathCompleted = false;
  
  /** Creates a new pathfindToApriltag. */
  public pathfindToApriltag(Pose2d updatedRobotPose, Camera camera, DifferentialDriveSubsystem swerve) {
    ...
    // TODO: removed this swerveDrive.allowPathMirroring = false;
  }
  ...
  public void initialize() {
    ...
    // TODO: no max speed found.
    PathConstraints constraints = new PathConstraints(
        1.0, 4.0,
        Units.degreesToRadians(540), Units.degreesToRadians(720));
    //PathConstraints constraints = new PathConstraints(
    //    Constants.maxSpeed, 4.0,
    //    Units.degreesToRadians(540), Units.degreesToRadians(720));
  ...
  public boolean isFinished() {
    ...
    if (/* swerveDrive.getPose().equals(updatedPose) */pathCompleted) {
      // TODO: removed this swerveDrive.allowPathMirroring = true;
      System.out.println(
          "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!FINISHED!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
      return true;
    } else {
