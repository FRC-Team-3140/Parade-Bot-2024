...
public class Lightshow extends SubsystemBase {
    ...
    public static final int kModeCaution = 1;
    public static final int kModeError = 2;
    public static final int kModeBlue = 3;
    public static final int kModeUSA = 4;
    public static final int kModeUSA2 = 5;
    public static final int kModeHoliday = 6;
    public static final int kModeHolloween = 7;
    public static final int kModeAdmirals = 8;
    public static final int kModeSparkleWhite = 9;
    public static final int kModeSparkleUSA = 10;
