...
public class Climber extends SubsystemBase {
    ...
    public Climber() {
        ...
        leftReachedTop = () -> encoderValues()[1] > 9.5;
        rightReachedTop = () -> encoderValues()[0] > 9.5;
        ...
        leftEncoder.setPositionConversionFactor(.287);
        rightEncoder.setPositionConversionFactor(.287);
